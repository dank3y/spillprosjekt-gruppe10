...
export class AmmoCounter extends UIElement {
	drawBox(ctx: CanvasRenderingContext2D): void {
		ctx.beginPath();
		ctx.save();
		ctx.fillStyle = '#FFF';
	...
	drawDesc(ctx: CanvasRenderingContext2D): void {
		ctx.beginPath();
		ctx.save();
	...
	drawAmmo(ctx: CanvasRenderingContext2D): void {
		ctx.beginPath();
		ctx.save();
	...
	drawReloadProgress(ctx: CanvasRenderingContext2D): void {
